...
if "%PHPBIN%" == "" set PHPBIN=S:\Universidad\Practica\Super de Alimentos\SuperBrujula3\ServerApp\php\.\php.exe
if not exist "%PHPBIN%" if "%PHP_PEAR_PHP_BIN%" neq "" goto USE_PEAR_PATH
GOTO RUN
:USE_PEAR_PATH
set PHPBIN=%PHP_PEAR_PHP_BIN%
:RUN
"%PHPBIN%" "S:\Universidad\Practica\Super de Alimentos\SuperBrujula3\ServerApp\php\phpunit" %*
